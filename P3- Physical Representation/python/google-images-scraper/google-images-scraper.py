...
def main(args):
	...
	parser.add_argument('-p', '--prefix', default='img', type=str, help='prefix for files')
	...
	url="https://www.google.co.in/search?q="+query+"&tbs=ic:color,isz:m&tbm=isch"
	...
	for i , (img , Type) in enumerate( ActualImages[0:max_images]):
	    try:
	        ...
	        if len(Type)==0:
	            ...
	            f = open(os.path.join(save_directory , prefix + "_"+ str(i)+"."+Type), 'wb')
	        f.write(raw_img)
	        f.close()
