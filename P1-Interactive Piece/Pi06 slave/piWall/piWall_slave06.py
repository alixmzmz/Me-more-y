...
player = OMXPlayer("/home/pi/Videos/scene_01_06_reading.mp4", args = ['--no-osd', '--loop'])
...
def play_scene_01(path, tags, args, source):
    ...
    player.load("/home/pi/Videos/scene_01_06_reading.mp4") # https://github.com/willprice/python-omxplayer-wrapper/issues/50

def play_scene_02(path, tags, args, source):
    print "play_scene_02"
    print path
    print source # who is sending the message to the server
    player.load("/home/pi/Videos/scene_02_06_dark.mp4")

def play_scene_03(path, tags, args, source):
    print "play_scene_03"
    print path
    print source # who is sending the message to the server
    player.load("/home/pi/Videos/scene_03_06_combe.mp4")

def play_scene_04(path, tags, args, source):
    print "play_scene_04"
    print path
    print source # who is sending the message to the server
    player.load("/home/pi/Videos/scene_04_05_music.mp4")
