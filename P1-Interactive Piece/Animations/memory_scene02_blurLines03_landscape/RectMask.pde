class RectMask { 
  ...
  RectMask(float xS, float yS, float xE, float yE, float s, float rectW, float rectH, String o) {  
    ...
    rectHeight = rectH;
    orientation = o;
    img = loadImage("animation-03-landscape.png");
  } 
  void update() { 
    ...
    if (orientation == "RIGHT") {
      ...
      if (x > xEnd) { 
        ...
        img = loadImage("animation-03-landscape-blur.png");
        speed *= -1;
      }
