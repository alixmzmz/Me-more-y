...
String originalText =  
  "The first time I saw Kike, my father was without a beard. After fifteen years. " +
  "I was coming back from a high school trip through Italy and the French coast. " + 
  "He was coming back from Madrid, where he had been in the hospital for months. At least they felt like months to me. Kike was very pale and had lost a lot of weight. " +
  "I could not stop crying. Very nervous, and happy. I was afraid for the first time in my life to lose someone. \n\n" + 
  "BLISSFUL REUNIONS. DREAD FEELINGS.";
...
void draw() {
  ...
  img = loadImage("data/images/_memory_scene03_texts_13.png");     
