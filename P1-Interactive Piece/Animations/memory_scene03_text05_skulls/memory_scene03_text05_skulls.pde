...
String originalText =  
  "My only tactile memories. My grandmother’s hands, when she was very old. " +
  "Extremely soft, with such thin skin it was almost transparent. I caressed her hands when I visited her on Sundays. A very delicate texture. " + 
  "Another skin memory; Nemiña’s head, being a couple of days old. The skull had barely fused. " +
  "It was the softest fuzziness. It was scary of how delicate she was. Exceptionally soft, but in a very different way from my grandmother. \n\n" + 
  "LEAVING SKINS GIVE WAY. SKULLS THAT ARRIVE.";
...
void draw() {
  ...
  img = loadImage("data/images/_memory_scene03_texts_14.png");     
