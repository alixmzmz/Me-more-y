...
String originalText =  
  "Confused. I was at my grandparents home in Pintor Seijo Rubio. The house was empty, ready to move. " +
  "There was only a couch in the middle of the living room. It was dark. " + 
  "It felt like I was the only person in the flat. " +
  "This memory intertwines with another; an ivory elephant horn in the bath, same house. Same darkness. \n\n" + 
  "SAILOR'S HOME. SAILOR'S TALES.";
...
void draw() {
  ...
  img = loadImage("data/images/_memory_scene03_texts_01.png");     
  ...
  text(textToDisplay, width/7, height/5, width-width/3, height);  // Text wraps within text box
