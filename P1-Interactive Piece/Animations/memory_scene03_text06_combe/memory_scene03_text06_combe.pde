...
String originalText =  
  "I was watching my great-grandmother in the backyard with the pigs. " +
  "My cousins, my sister and I looked through the glass in the kitchen’s door. " + 
  "She hit them with a stick on their backs and they ran around in circles. To me, they looked as they were in the a gym class.  " +
  "My great-grandfather used to comb my great-grannies hair in the small toilet under the stairs. Both standing. Years later I would see my grandfather combing his wife’s hair in the same way. With the same love.  \n\n" + 
  "BACKYARD DOORS. MEN WHO COMBE THEIR WIVE'S HAIRS.";
...
void setup() {
  ...
  font = createFont("data/TypoPRO-Amble-Regular.ttf", 42);
  textFont(font);
  smooth(8);
...
void draw() {
  ...
  img = loadImage("data/images/_memory_scene03_texts_12.png");     
